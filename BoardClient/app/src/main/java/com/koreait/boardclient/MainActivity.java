...
public class MainActivity extends AppCompatActivity {
        ...
        Thread thread = new Thread(){
            public void run() {
                ...
                try {
                    ...
                    httpManager.requestByPost("http://192.168.35.71:7777/rest/board", json.toString());
    ...
    public void getList(View view){
        ...
        Thread thread = new Thread(){
            public void run() {
                ArrayList<Board> boardList = httpManager.requestByGet("http://192.168.35.71:7777/rest/board");
