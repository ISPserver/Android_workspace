...
public class MainActivity extends AppCompatActivity {
    ...
    public void printData(String data){
        ...
        try {
            ...
            Log.d(TAG,"json 배열 길이는"+jsonArray.length());
            for(int i=0; i<jsonArray.length(); i++){
                ...
                memberList.add(member);//리스트에 멤버VO 추가
            }
    ...
    public void loadData(View view){
        ...
        //쓰레드는 하나의 프로세스내에서 독립적으로(비동기적)실행되는 , 또하나의 세부 실행 단위
        ConnectManager manager = new ConnectManager(this,"http://192.168.35.71:8888/rest/member",null);
        manager.start();
